...
public class KeyValueMain {
    ...
    public static void main(String args[]) {
        ...
        FeedbackItem fb1 = new FeedbackItem("partition1", "row1");
        FeedbackItem fb2 = new FeedbackItem("partition1", "row2");

        FeedbackItem fb3 = new FeedbackItem("partition2", "row1");
        FeedbackItem fb4 = new FeedbackItem("partition2", "row2");
